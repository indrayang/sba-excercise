...
namespace ProjectManagement.BusinessClasses
{
    public class TaskBC
    {
        DataAccessClasses.ProjectManagerEntities dbContext = null;
        public TaskBC()
        {
            dbContext = new DataAccessClasses.ProjectManagerEntities();
        }

        public TaskBC(DataAccessClasses.ProjectManagerEntities context)
        {
            dbContext = context;
        }
        ...
        public int InsertTaskDetails(Task task)
        {
            using (dbContext)
            {
                ...
                if (task.Priority == 0)
                {
                    dbContext.ParentTasks.Add(new DataAccessClasses.ParentTask()
                    {
                ...
                {
                    DataAccessClasses.Task taskDetail = new DataAccessClasses.Task()
                    {
